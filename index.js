...
function start() {
    ...
    if (player1Input.value.trim() === '' || player2Input.value.trim() === '') {
        ...
        gridContainer.style.gridTemplateRows = "repeat(".concat(size_1, ", minmax(0, 100px))");
        gridContainer.style.gridTemplateColumns = "repeat(".concat(size_1, ", minmax(0,100px))");
...
function checkRowCol(r, c, symbol, size) {
    ...
    for (var i = 0; i < size; i++) {
        var clickedCellR = document.querySelector("[data-row=\"".concat(r, "\"][data-column=\"").concat(i, "\"]"));
        var rowVal = (clickedCellR === null || clickedCellR === void 0 ? void 0 : clickedCellR.textContent) || '';
        var clickedCellC = document.querySelector("[data-row=\"".concat(i, "\"][data-column=\"").concat(c, "\"]"));
        var colVal = (clickedCellC === null || clickedCellC === void 0 ? void 0 : clickedCellC.textContent) || '';
        if (rowVal === symbol) {
            rowCount++;
        }
        if (colVal === symbol) {
...
function checkDiagonals(symbol, size) {
    ...
    for (var i = 0; i < size; i++) {
        var diagonalL = document.querySelector("[data-row=\"".concat(i, "\"][data-column=\"").concat(i, "\"]"));
        var valL = (diagonalL === null || diagonalL === void 0 ? void 0 : diagonalL.textContent) || '';
        if (valL === symbol) {
            mainDiagonalCount++;
        }
        var diagonalR = document.querySelector("[data-row=\"".concat(i, "\"][data-column=\"").concat(size - i - 1, "\"]"));
        var valR = (diagonalR === null || diagonalR === void 0 ? void 0 : diagonalR.textContent) || '';
        if (valR === symbol) {
            antiDiagonalCount++;
        }
    }
